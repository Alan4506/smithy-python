 ...
 *
 * <p>This hard-codes the operations until the {@code aws.api#longPoll} trait
 * ships in service models, after which this can check for the trait instead.
 * Keeping the list here keeps AWS service names out of the generic codegen.
 */
